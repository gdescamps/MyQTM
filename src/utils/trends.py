...
def detect_trends(
    ...
    trends = []
    last_end = None  # To avoid overlaps

    # 4. Build raw segments
    for i in range(1, len(cross_ml_idx)):
        ...
        # 5. filter on performance direction & magnitude; otherwise mark as range
        if trend_type_ml == "bullish" and ret_per_days >= avg_daily_percent_thr / 100:
            ...
            last_end = adj_end  # Update last end
        elif (
